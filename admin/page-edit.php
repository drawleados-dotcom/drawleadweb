...
<form method="post" novalidate>
  ...
  <div class="card">
    ...
    <div class="field-hint">Only applies to Home, Home 2.0, Home 5, Final Home, About Us, and Analyze — Platform, Industry, and Solution pages always use their own mega menus regardless of this setting.</div>
  </div>
